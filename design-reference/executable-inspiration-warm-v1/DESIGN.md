...
- **Display:** 每个页面最多一个，用于顶层方向句，桌面 36-52px，移动端 28-34px。
...
全局使用深紫侧栏、暖纸工作区和轻透明顶栏。桌面侧栏展开宽 288px，可保留当前 72px 收纳态；顶栏目标高度 88px。内容宽度上限 1620px，标准页边距为 48px，核心工作区依任务使用两栏或三栏。
